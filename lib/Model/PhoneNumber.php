...
class PhoneNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['country_code']) > 4)) {
        ...
        if ((mb_strlen($this->container['phone_number']) > 14)) {
            $invalidProperties[] = "invalid value for 'phone_number', the character length must be smaller than or equal to 14.";
        }

        if ((mb_strlen($this->container['phone_number']) < 4)) {
            $invalidProperties[] = "invalid value for 'phone_number', the character length must be bigger than or equal to 4.";
        }
     ...
     * Sets country_code
     *
     * @param string $country_code Consumer provided country code.
     *
     * @return self
     */
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling PhoneNumber., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($country_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling PhoneNumber., must be bigger than or equal to 1.');
        }
     ...
     * Sets phone_number
     *
     * @param string $phone_number Consumer-provided phone number.
     *
     * @return self
     */
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((mb_strlen($phone_number) > 14)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling PhoneNumber., must be smaller than or equal to 14.');
        }
        if ((mb_strlen($phone_number) < 4)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling PhoneNumber., must be bigger than or equal to 4.');
        }
