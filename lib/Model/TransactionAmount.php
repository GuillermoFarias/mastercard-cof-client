...
class TransactionAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'transaction_currency_code' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('transaction_currency_code', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['transaction_amount']) > 18)) {
            $invalidProperties[] = "invalid value for 'transaction_amount', the character length must be smaller than or equal to 18.";
        }
     ...
     *
     * @param string $transaction_amount Amount of the transaction.
     *
     * @return self
     */
    public function setTransactionAmount($transaction_amount)
    {
        ...
        if ((mb_strlen($transaction_amount) > 18)) {
            throw new \InvalidArgumentException('invalid length for $transaction_amount when calling TransactionAmount., must be smaller than or equal to 18.');
        }
     ...
     *
     * @param string $transaction_currency_code Currency in which the transaction amount is expressed. Format is ISO 4217 standard alpha-3 code.
     *
     * @return self
     */
    public function setTransactionCurrencyCode($transaction_currency_code)
    {
        if (is_null($transaction_currency_code)) {
            throw new \InvalidArgumentException('non-nullable transaction_currency_code cannot be null');
        }
