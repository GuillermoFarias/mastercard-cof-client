...
/**
 * CheckoutDigitalCardData Class Doc Comment
 *
 * @category Class
 ...
 */
class CheckoutDigitalCardData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckoutDigitalCardData';
    ...
    */
    ...
    public function setDescriptorName($descriptor_name)
    {
        ...
        if ((mb_strlen($descriptor_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $descriptor_name when calling CheckoutDigitalCardData., must be smaller than or equal to 64.');
        }
    ...
    public function setArtUri($art_uri)
    {
        ...
        if ((mb_strlen($art_uri) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $art_uri when calling CheckoutDigitalCardData., must be smaller than or equal to 1024.');
        }
    ...
    public function setCoBrandName($co_brand_name)
    {
        ...
        if ((mb_strlen($co_brand_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $co_brand_name when calling CheckoutDigitalCardData., must be smaller than or equal to 128.');
        }
