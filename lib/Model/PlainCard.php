 ...
 */
class PlainCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PlainCard';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pan_expiration_month'] === null) {
            $invalidProperties[] = "'pan_expiration_month' can't be null";
        }
        if ((mb_strlen($this->container['pan_expiration_month']) > 2)) {
            $invalidProperties[] = "invalid value for 'pan_expiration_month', the character length must be smaller than or equal to 2.";
        }

        if ($this->container['pan_expiration_year'] === null) {
            $invalidProperties[] = "'pan_expiration_year' can't be null";
        }
        if ((mb_strlen($this->container['pan_expiration_year']) > 4)) {
    ...
    public function setPrimaryAccountNumber($primary_account_number)
    {
        ...
        if ((mb_strlen($primary_account_number) > 19)) {
            throw new \InvalidArgumentException('invalid length for $primary_account_number when calling PlainCard., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($primary_account_number) < 9)) {
            throw new \InvalidArgumentException('invalid length for $primary_account_number when calling PlainCard., must be bigger than or equal to 9.');
        }
     ...
     *
     * @param string $pan_expiration_month Expiration month of the Card, expressed as a two-digit calendar month.
     *
     * @return self
     */
    public function setPanExpirationMonth($pan_expiration_month)
    {
        ...
        if ((mb_strlen($pan_expiration_month) > 2)) {
            throw new \InvalidArgumentException('invalid length for $pan_expiration_month when calling PlainCard., must be smaller than or equal to 2.');
        }
     ...
     *
     * @param string $pan_expiration_year Expiration year of the Card, expressed as a four-digit calendar year.
     *
     * @return self
     */
    public function setPanExpirationYear($pan_expiration_year)
    {
        ...
        if ((mb_strlen($pan_expiration_year) > 4)) {
            throw new \InvalidArgumentException('invalid length for $pan_expiration_year when calling PlainCard., must be smaller than or equal to 4.');
        }
     ...
     *
     * @param string|null $card_security_code Card security code (i.e. Card CVC).
     *
     * @return self
     */
