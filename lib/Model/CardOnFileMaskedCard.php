...
/**
 * CardOnFileMaskedCard Class Doc Comment
 *
 * @category Class
 ...
 */
class CardOnFileMaskedCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardOnFileMaskedCard';
    ...
    protected static $openAPITypes = [
        ...
        'digital_card_data' => '\MastercardApiClient\Model\DigitalCardData',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['src_digital_card_id']) && (mb_strlen($this->container['src_digital_card_id']) > 36)) {
    ...
    public function setSrcDigitalCardId($src_digital_card_id)
    {
        ...
        if ((mb_strlen($src_digital_card_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $src_digital_card_id when calling CardOnFileMaskedCard., must be smaller than or equal to 36.');
        }
    ...
    public function setPanLastFour($pan_last_four)
    {
        ...
        if ((mb_strlen($pan_last_four) > 4)) {
            throw new \InvalidArgumentException('invalid length for $pan_last_four when calling CardOnFileMaskedCard., must be smaller than or equal to 4.');
        }
     ...
     *
     * @return \MastercardApiClient\Model\DigitalCardData
     */
     ...
     *
     * @param \MastercardApiClient\Model\DigitalCardData $digital_card_data digital_card_data
     *
     * @return self
     */
    ...
    public function setPanExpirationMonth($pan_expiration_month)
    {
        ...
        if ((mb_strlen($pan_expiration_month) > 2)) {
            throw new \InvalidArgumentException('invalid length for $pan_expiration_month when calling CardOnFileMaskedCard., must be smaller than or equal to 2.');
        }
    ...
    public function setPanExpirationYear($pan_expiration_year)
    {
        ...
        if ((mb_strlen($pan_expiration_year) > 4)) {
            throw new \InvalidArgumentException('invalid length for $pan_expiration_year when calling CardOnFileMaskedCard., must be smaller than or equal to 4.');
        }
    ...
    public function setPaymentCardDescriptor($payment_card_descriptor)
    {
        ...
        if ((mb_strlen($payment_card_descriptor) > 32)) {
            throw new \InvalidArgumentException('invalid length for $payment_card_descriptor when calling CardOnFileMaskedCard., must be smaller than or equal to 32.');
        }
    ...
    public function setPaymentCardType($payment_card_type)
    {
        ...
        if ((mb_strlen($payment_card_type) > 32)) {
            throw new \InvalidArgumentException('invalid length for $payment_card_type when calling CardOnFileMaskedCard., must be smaller than or equal to 32.');
        }
