...
/**
 * AccountReferenceData Class Doc Comment
 *
 * @category Class
 * @package  MastercardApiClient
 * @author   OpenAPI Generator team
 ...
 */
class AccountReferenceData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountReferenceData';
    ...
    public const CARD_SOURCE_CARDHOLDER = 'CARDHOLDER';
    public const CARD_SOURCE_MERCHANT = 'MERCHANT';
     ...
     * @return string[]
     */
    public function getCardSourceAllowableValues()
    {
        return [
            self::CARD_SOURCE_CARDHOLDER,
            self::CARD_SOURCE_MERCHANT,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('card_source', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getCardSourceAllowableValues();
        if (!is_null($this->container['card_source']) && !in_array($this->container['card_source'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'card_source', must be one of '%s'",
                $this->container['card_source'],
    ...
    {
        return $this->container['card_source'];
    }

    /**
     * Sets card_source
     *
     * @param string|null $card_source Holds the Origin of Card Enrollment. Internally following mappings are applied: CARDHOLDER -> CARD_ADDED_MANUALLY MERCHANT -> CARD_ON_FILE
     *
     * @return self
     */
    public function setCardSource($card_source)
    {
        if (is_null($card_source)) {
            throw new \InvalidArgumentException('non-nullable card_source cannot be null');
        }
        $allowedValues = $this->getCardSourceAllowableValues();
        if (!in_array($card_source, $allowedValues, true)) {
        ...
        $this->container['card_source'] = $card_source;
