...
/**
 * CardOnFileRequest Class Doc Comment
 *
 * @category Class
 * @package  MastercardApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CardOnFileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardOnFileRequest';
    ...
    protected static $openAPITypes = [
        ...
        'account_reference' => '\MastercardApiClient\Model\AccountReference'
    ];
    ...
    */
     ...
     * Sets src_dpa_id
     *
     * @param string $src_dpa_id Client ID. This will be the DPA ID of the v2 merchant.
     *
     * @return self
     */
     ...
     * Sets correlation_id
     *
     * @param string|null $correlation_id Correlation Id. Must be passed when merchantTransactionId is passed.
     *
     * @return self
     */
     ...
     *
     * @param string|null $merchant_account_id Merchant issued Account ID for a consumer. If provided, it serves as an integration check.
     *
     * @return self
     */
     ...
     *
     * @return \MastercardApiClient\Model\AccountReference|null
     */
     ...
     *
     * @param \MastercardApiClient\Model\AccountReference|null $account_reference account_reference
     *
     * @return self
     */
