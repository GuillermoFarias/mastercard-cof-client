...
/**
 * CheckoutReferenceData Class Doc Comment
 *
 * @category Class
 * @package  MastercardApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CheckoutReferenceData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckoutReferenceData';
    ...
    protected static $openAPITypes = [
        ...
        'encrypted_card' => '\MastercardApiClient\Model\PlainCard'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['merchant_card_id']) && (mb_strlen($this->container['merchant_card_id']) > 64)) {
            $invalidProperties[] = "invalid value for 'merchant_card_id', the character length must be smaller than or equal to 64.";
        }

        if (!is_null($this->container['merchant_transaction_id']) && (mb_strlen($this->container['merchant_transaction_id']) > 64)) {
            $invalidProperties[] = "invalid value for 'merchant_transaction_id', the character length must be smaller than or equal to 64.";
        }
    ...
    public function setMerchantCardId($merchant_card_id)
    {
        ...
        if ((mb_strlen($merchant_card_id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $merchant_card_id when calling CheckoutReferenceData., must be smaller than or equal to 64.');
        }
    ...
    public function setMerchantTransactionId($merchant_transaction_id)
    {
        ...
        if ((mb_strlen($merchant_transaction_id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $merchant_transaction_id when calling CheckoutReferenceData., must be smaller than or equal to 64.');
        }
     ...
     * Gets encrypted_card
     *
     * @return \MastercardApiClient\Model\PlainCard|null
     */
     ...
     * Sets encrypted_card
     *
     * @param \MastercardApiClient\Model\PlainCard|null $encrypted_card encrypted_card
     *
     * @return self
     */
