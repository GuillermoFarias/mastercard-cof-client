...
/**
 * DynamicDataType Class Doc Comment
 *
 * @category Class
 * @package  MastercardApiClient
 * @author   OpenAPI Generator team
...
class DynamicDataType
{
     ...
     */
    public const CARD_APPLICATION_CRYPTOGRAM_SHORT_FORM = 'CARD_APPLICATION_CRYPTOGRAM_SHORT_FORM';

    public const DYNAMIC_CARD_SECURITY_CODE = 'DYNAMIC_CARD_SECURITY_CODE';
    ...
    {
        return [
            self::CARD_APPLICATION_CRYPTOGRAM_SHORT_FORM,
            self::DYNAMIC_CARD_SECURITY_CODE,
            self::NONE
        ];
    }
}
